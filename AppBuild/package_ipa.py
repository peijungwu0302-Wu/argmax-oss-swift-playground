...
assert info["CFBundleShortVersionString"] == "1.8.1" and info["CFBundleVersion"] == "14"
...
assert widget_info["CFBundleShortVersionString"] == "1.8.1" and widget_info["CFBundleVersion"] == "14"
...
print("PASS: single Widget extension, universal iPhone/iPad, background audio, NSSupportsLiveActivities, version 1.8.1 (14) and unsigned IPA integrity")
print(output)
