...
assert info["CFBundleShortVersionString"] == "1.8.2" and info["CFBundleVersion"] == "15"
...
assert widget_info["CFBundleShortVersionString"] == "1.8.2" and widget_info["CFBundleVersion"] == "15"
...
print("PASS: single Widget extension, universal iPhone/iPad, background audio, NSSupportsLiveActivities, version 1.8.2 (15) and unsigned IPA integrity")
print(output)
