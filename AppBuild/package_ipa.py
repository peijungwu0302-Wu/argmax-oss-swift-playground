...
assert info["CFBundleShortVersionString"] == "1.8.3" and info["CFBundleVersion"] == "16"
...
assert widget_info["CFBundleShortVersionString"] == "1.8.3" and widget_info["CFBundleVersion"] == "16"
...
print("PASS: single Widget extension, universal iPhone/iPad, background audio, NSSupportsLiveActivities, version 1.8.3 (16) and unsigned IPA integrity")
print(output)
