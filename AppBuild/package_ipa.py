...
assert info["CFBundleShortVersionString"] == "1.9.2" and info["CFBundleVersion"] == "21"
...
assert widget_info["CFBundleShortVersionString"] == "1.9.2" and widget_info["CFBundleVersion"] == "21"
...
print("PASS: single Widget extension, universal iPhone/iPad, background audio, NSSupportsLiveActivities, version 1.9.2 (21) and unsigned IPA integrity")
print(output)
